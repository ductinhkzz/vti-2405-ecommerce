...
const AboutUs = () => {
  ...
  return (
    <>
      ...
      />
      <ImageList medias={[{ url: imgList1, }, { url: imgList2 }]} />
      <HeroSection
        medias={[
          {
            isVideo: false,
        ...
        actions={[
          {
            text: 'Explore our bed collection',
            url: '',
          },
        ]}
      />
      ...
      />
      <ImageList medias={[{ url: imgList3 }, { url: imgList4 }]} />
